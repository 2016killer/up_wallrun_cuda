...
if CLIENT then
    ...
    UltiPar.SetRollOffset_HWallRun = function(offset)
        rolloffset = offset
    end
end
...
local function effectstart_default(self, ply, isright)
    ...
    -- roll offset
    if CLIENT and self.roll_offset ~= 0 then
        UltiPar.SetRollOffset_HWallRun((isright or 1) * self.roll_offset)
    end
end
...
local function effectclear_default(self, ply, endtype)
    ...
    -- roll offset
    if CLIENT then
        UltiPar.SetRollOffset_HWallRun(0)
    end
end
...
UltiPar.RegisterEffect(
    ...
    'default',
    {
        VManipAnim = 'horizontalwallrun_YongLi',
        VMLegsAnim = '',
        WOSAnim = '',
